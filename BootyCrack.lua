...
local Window = OrionLib:MakeWindow({Name = "GGDarkninja Hub | Miner's Haven", HidePremium = false, IntroText = "GGDarkninja Hub", SaveConfig = true, ConfigFolder = "OrionTest"})
